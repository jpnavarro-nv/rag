...
echo ""
echo "To restart:"
echo "  Full stack:  ./01-start-infrastructure.sh && ./02-start-redis.sh && ./03-start-nim-models.sh && ./04-wait-nim-models.sh && ./05-start-nv-ingest-ms.sh && ./06-start-ingest-server.sh && ./07-start-rag-server.sh && ./08-start-frontend.sh"
echo "  Query-only:  ./01-start-infrastructure.sh && ./02-start-redis.sh && ./07-start-rag-server.sh && ./08-start-frontend.sh"
